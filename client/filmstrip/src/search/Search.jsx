      ...
      <div className="mx-auto px-8 mt-12">
        ...
        <div className="relative">
          ...
          <button
            id="searchButton"
            type="button"
            className="text-[#18191A] absolute end-2.5 bottom-2.5 bg-[#ffd500] hover:bg-[#997f00] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-[#ffd500] dark:hover:bg-[#997f00] dark:focus:ring-blue-800"
